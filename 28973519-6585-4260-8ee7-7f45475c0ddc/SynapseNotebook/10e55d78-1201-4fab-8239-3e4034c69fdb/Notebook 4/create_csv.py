...
def create_sentences_csv(data, filename="sentences.csv"):
    """Creates a CSV file from a list of (sentence, belbin_role, role_sentiment) tuples."""
    with open(filename, 'w', newline='', encoding='utf-8') as csvfile:
        writer = csv.writer(csvfile)
        # No header row needed
        for sentence, belbin_role, role_sentiment in data:
            writer.writerow([sentence, belbin_role, role_sentiment])
    print(f"Created CSV file: {filename}")

# Your CLEAN data (replace this with your complete, corrected list)
sentences_data = [
    ...
    ("We need to analyze all the data before moving forward.", "Monitor Evaluator", "neutral"),  # Duplicate removed
...
if __name__ == "__main__":
    create_sentences_csv(sentences_data)